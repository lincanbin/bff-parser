  ...
  async execute () {
    ...
    return (new Promise(async (resolve, reject) => {
      try {
        ...
        let result = await _this.bffParserInstance.requestProcessor(_this.bffItemBody, levelNamePrefix + _this.bffItemAlias)
        // console.debug('result of execute: ', result)
        _this.bffParserInstance.addRequestCount()
        _this.bffParserInstance.result.addTo(levelNamePrefix + _this.bffItemAlias, result)
